...
----
dependencies {
    implementation("sk.ainet.core:skainet-lang-core:0.52.1")     // tensors, DSL, training
    implementation("sk.ainet.core:skainet-backend-cpu:0.52.1")   // CPU ops
    implementation("sk.ainet.core:skainet-compile-dag:0.52.1")   // autograd (training context)
    implementation("sk.ainet.core:skainet-data-api:0.52.1")      // Dataset / DataBatch
    implementation("sk.ainet.core:skainet-data-simple:0.52.1")   // embedded Iris
    runtimeOnly("sk.ainet.core:skainet-backend-jni-cpu:0.52.1")  // NEON kernels (see below)
}
----
