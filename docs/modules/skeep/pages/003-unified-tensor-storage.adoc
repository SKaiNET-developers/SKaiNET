...
Design record: https://github.com/SKaiNET-developers/SKaiNET/blob/develop/docs/design/memory/memory-architecture-proposal.md[memory-architecture-proposal.md] and https://github.com/SKaiNET-developers/SKaiNET/blob/develop/docs/design/memory/memory-architecture-milestones-prd.md[memory-architecture-milestones-prd.md] (repository `docs/design/memory/`)
...
`docs/design/memory/memory-architecture-proposal.md` (revision 2); the
milestone scoping, sample apps and acceptance numbers are in
`docs/design/memory/memory-architecture-milestones-prd.md`. The thirteen
...
* Design record: `docs/design/memory/memory-architecture-proposal.md`,
  `docs/design/memory/memory-architecture-milestones-prd.md`
