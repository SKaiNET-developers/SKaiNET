...
- Key concept: Operators – Kotlin interfaces overridden in different contexts:
  ...
  • Real computation is provided by XLA compilation targeting specific hardware (CPU, GPU, TPU) during execution.
        ...
        "functions": [
          {
            ...
            "returnType": "Tensor",
            "sinceVersion": "0.1.0",
            "statusByBackend": {"CPU": "Implemented", "GPU": "Implemented", "TPU": "Implemented"},
