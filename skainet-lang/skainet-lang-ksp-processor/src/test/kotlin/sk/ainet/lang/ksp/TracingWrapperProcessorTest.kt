...
class TracingWrapperProcessorTest {
    ...
    fun testAnnotationBasedProcessingProperty() {
        ...
        assertTrue(
            annotatedResult.messages.contains("Found 1 tracing interfaces, 0 Graph DSL interfaces, and 0 Network DSL interfaces"),
        ...
        assertTrue(
            nonAnnotatedResult.messages.contains("No interfaces annotated with @GenerateTracingWrapper, @GenerateGraphDsl, or @GenerateNetworkDsl found"),
        ...
        assertTrue(
            mixedResult.messages.contains("Found 2 tracing interfaces, 0 Graph DSL interfaces, and 0 Network DSL interfaces"),
    ...
    fun testEmptyInterfaceHandling() {
        ...
        assertTrue(
            result.messages.contains("Found 1 tracing interfaces, 0 Graph DSL interfaces, and 0 Network DSL interfaces"),
